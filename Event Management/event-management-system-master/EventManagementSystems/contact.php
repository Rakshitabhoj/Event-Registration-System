        ...
        <div class = "content"><!--body content holder-->
            ...
            <div class="container">
                <div class="col-md-6 contacts">
                    <h1><span class="glyphicon glyphicon-user"></span>Rimsha Sultana <br> Rakshita Bhoj</h1>
                    <p>
                        <span class="glyphicon glyphicon-envelope"></span> Email: rimsha14sultana@gmail.com<br>
                        <span class="glyphicon glyphicon-link"></span> Facebook: www.facebook.com/rimshas_54<br>
