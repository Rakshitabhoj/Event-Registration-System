    ...
    <div class = "col-md-12">
        <div class = "container">
            <div class = "jumbotron"><!--jumbotron-->
                <h1>Sri Siddhartha Institute Of Technology</h1><!--jumbotron heading-->
                <p><!--jumbotron content-->
                If you're looking for "HOW TO ?" and "WHERE TO" participate in ssit's biggest event Kalotsava ,then this the right place!
                </p>
                <p id="dateAndTime"></p>
